...
print("EfficientNet-B2 with gradual unfreezing + Cosine LR Scheduler")
...
def train_model(optimizer, scheduler):
    ...
    for epoch in range(EPOCHS):
        ...
        if epoch == 5:
            ...
            print("Unfreezing last 4 EfficientNet blocks")
        ...
        for phase in ["train", "val"]:
            ...
            # STEP SCHEDULER AFTER TRAIN PHASE
            if phase == "train":
                scheduler.step()
...
train_model(optimizer, scheduler)
