...
print(f"_____________________Adam to SGD, added a thing to not update batch norm when unfreezing")
# =========================
# CONFIG
# =========================
...
# Initially train classifier only
optimizer = optim.SGD(
...
def train_model():
    ...
    for epoch in range(EPOCHS):
        ...
        # =========================
        # GRADUAL UNFREEZING STEP*********************************************
        # =========================

        if epoch == 5:

            print("\nUnfreezing last 3 MobileNet feature blocks...")

            for param in model.features[-3:].parameters():
                param.requires_grad = True

            for m in model.features[-3:].modules():
            ...
            optimizer = optim.SGD(
                [
                    ...
                    {"params": model.features[-3:].parameters(), "lr": 0.001},
                ],
                momentum=0.9,
                weight_decay=1e-4,
            )
